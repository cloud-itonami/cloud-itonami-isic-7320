# Operator Quickstart — Market research and public opinion polling

Shortest path from clone to a verified local dry-run for **ISIC 7320** (`cloud-itonami-isic-7320`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-7320.git
cd cloud-itonami-isic-7320
```
...
- Blueprint governor key: `survey-integrity-governor`
- Likely source path: `polling.governor.cljc`
